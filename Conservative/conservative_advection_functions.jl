...
function hB_x(i, j, k, grid, A)
    return -ℑxyᶠᶜᵃ(i, j, k, grid, ∂yᶜᶠᶜ, A)
end

function hB_y(i, j, k, grid, A)
...
function div_lorentz_x(i, j, k, grid, advection, fields)
...
function div_lorentz_y(i, j, k, grid, advection, fields)
